    ...
    if not finish:
        ...
        for asteroid in asteroids:
            if sprite.spritecollide(asteroid, bullets, True):
                if asteroid.got_hit():  # Перевіряємо, чи астероїд повинен бути знищений
                    score += 1  # Додаємо одиницю до рахунку за знищення астероїда
                    new_asteroid = Asteroid(img_asteroid, win_width + randint(50, 200), randint(80, win_height - 80),
                                            80, 50, randint(1, 3))
